...
use App\Http\Controllers\CarpetasMedicasController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('/carpetas-medicas', CarpetasMedicasController::class);
    ...
    Route::put('users/{id}/active', [UserController::class, 'updateActive']);
